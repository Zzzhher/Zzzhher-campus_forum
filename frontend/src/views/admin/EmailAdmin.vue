...
<template>
  <div class="email-admin">
    ...
    <el-table :data="emailList.list" height="400">
      ...
      <el-table-column prop="email" label="收件人" width="180" align="center" show-overflow-tooltip/>
      ...
      <el-table-column prop="title" label="邮件主题" width="180" align="center" show-overflow-tooltip/>
      <el-table-column prop="content" label="邮件内容" width="260" align="center" show-overflow-tooltip/>
