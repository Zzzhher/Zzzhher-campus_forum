...
public final class Const {
    ...
    public final static String MQ_AI_MODERATION = "ai.moderation";
    public final static String MQ_AI_RESPONSE = "ai.response";
    // 用户角色
    ...
    public final static String FORUM_DAILY_POST_COUNTER = "forum:daily:post:";
}
