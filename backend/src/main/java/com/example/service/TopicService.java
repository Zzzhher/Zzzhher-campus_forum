...
public interface TopicService extends IService<Topic> {
    ...
    // 审核相关方法
    Page<Topic> listPendingReviewTopics(int page, int size);

    Page<TopicComment> listPendingReviewComments(int page, int size);

    void approveTopic(int tid);

    void rejectTopic(int tid);

    void approveComment(int id);

    void rejectComment(int id);

    void batchApproveTopics(List<Integer> ids);

    void batchRejectTopics(List<Integer> ids);
